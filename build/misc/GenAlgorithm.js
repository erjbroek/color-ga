...
export default class GenAlgorithm {
    ...
    renderTarget(canvas) {
        CanvasUtil.fillRectangleWithGradient(canvas, canvas.width * 0.55, canvas.height * 0.03, canvas.width * 0.3, canvas.height * 0.94, [
        ...
        CanvasUtil.writeText(canvas, hexColor, canvas.width * 0.73, canvas.height * 0.5, 'center', 'system-ui', 50, textColor, 500);
